...
//     void f(int ind , vector<vector<int>>&ret,vector<int>&ans, vector<int>&candidates ,int target){  
...
//             if(ind> && candidates[i]==candidates[i-1]){
//                 continue;
//             } 
...
//             f(ind+1,ret,ans,candidates,target-candidates[i]);
//             ans.pop_back();
//             f(ind+1,ret,ans,candidates,target);
